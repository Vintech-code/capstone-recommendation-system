...
async function installAdminApi(page: Page) {
  ...
  await page.route('**/api/v1/**', (route) => {
    ...
    if (path === '/api/v1/admin/reports') return json(route, { data: { generatedAt: '2026-08-08T12:00:00+08:00', from: null, to: null, scope: 'institution', studentCount: 1, assessmentActivity: 1, completedAssessments: 1, assessmentCompletionRate: 100, recommendationRuns: 1, programmeSaves: 0, assessmentCompletionsByMonth: [{ month: '2026-08', count: 1 }] } })
    if (path === '/api/v1/admin/activity') return json(route, { data: [{ id: 1, actor: 'Admin User', action: 'configuration.published', subjectType: 'configuration_version', subjectReference: '7', metadata: null, createdAt: '2026-08-08T12:00:00+08:00' }] })
