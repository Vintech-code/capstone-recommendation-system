...
describe('Student dashboard', () => {
  ...
  it('preserves the latest completed result while a retake is in progress', async () => {
    ...
    render(<StudentAssessmentHistoryPage onBack={vi.fn()} onOpenAssessment={vi.fn()} onExploreMatches={onExploreMatches} />)
    ...
    await user.click(screen.getByRole('button', { name: 'Explore Matches' }))
