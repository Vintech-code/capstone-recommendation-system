...
async function defaultFetch(
  ...
  if (url === '/api/v1/student/profile') {
    return Response.json({ data: {
      ...
      riasec: { sessionReference: 'ASMT-000001', availableAt: '2026-08-09T09:00:00+08:00', primary: { code: 'I', label: 'Investigative' }, secondary: { code: 'C', label: 'Conventional' }, tertiary: { code: 'R', label: 'Realistic' }, code: 'I-C-R', dimensions: [{ code: 'I', label: 'Investigative', value: 20 }, { code: 'C', label: 'Conventional', value: 18 }, { code: 'R', label: 'Realistic', value: 17 }] },
      careerInterests: ['Software and application development'],
      about: 'The latest recorded RIASEC result is I-C-R (Investigative, Conventional, and Realistic). The student selected Problem-solving as a self-reported strength.',
    } })
  }
  ...
  if (url === '/api/v1/student/programmes') {
    return Response.json({ data: {
      academicYear: '2026-2027', catalogueVersion: 2,
      programmes: [{ id: 'bs-information-technology', name: 'BS Information Technology', code: 'BSIT', majors: [], riasecProfile: ['I', 'R', 'C'], description: 'Focuses on applying computing to organisational needs.', learningAreas: ['Software development'], requirements: ['Meet published admission requirements.'], readinessPrompt: 'Discuss your interest in technology.' }],
    } })
  }
